...
**548 Tier-0/1 green** (+2 replayed Fable; re-run 2026-08-07, 57 files). **H-06 is fixed (D-60)**,
**X-24 is fixed (D-61)**, **X-27 is fixed (D-62)**, **X-23 is fixed (D-63)** and **X-26 is fixed
(D-65)**; **X-12b is DONE**.
